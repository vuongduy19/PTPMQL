    ...
    public class HeThongPhanPhoiController : Controller
    {
        ...
        public async Task<IActionResult> Details(string id)
        {
            ...
            var heThongPhanPhoi = await _context.HeThongPhanPhois
                .FirstOrDefaultAsync(m => m.HeThongPhanPhoiId == id);
        ...
        public async Task<IActionResult> Create([Bind("HeThongPhanPhoiId,TenHeThong,DiaChi,SoDienThoai")] HeThongPhanPhoi heThongPhanPhoi)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("HeThongPhanPhoiId,TenHeThong,DiaChi,SoDienThoai")] HeThongPhanPhoi heThongPhanPhoi)
        {
            if (id != heThongPhanPhoi.HeThongPhanPhoiId)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!HeThongPhanPhoiExists(heThongPhanPhoi.HeThongPhanPhoiId))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.HeThongPhanPhois.Any(e => e.HeThongPhanPhoiId == id);
        }
    }
}
